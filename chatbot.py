...
user_prompt = f" Imagine yourself as a trained chef. Based on the ingredients mentioned by user{user_input}, combine all ingredients and generate a recipe for one simple dish across various cuisines. Present the response in the following format: Name of the dish, Preparation time, Ingredients, Steps to prepare the dish."
